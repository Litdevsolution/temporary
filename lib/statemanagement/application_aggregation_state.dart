...
class ApplicationAggregationState extends GetxController {
  ...
  Future<void> fetchApplicationAggregation({
    ...
    try {
      ...
      final apiUrl =
          '${repository.uri}/${repository.application_aggregations}?start=$startDate&end=$endDate';
      ...
      if (response.statusCode == 200) {
        try {
          ...
          if (responseData is Map<String, dynamic>) {
            final profileData = ApplicationAggregationModel.fromJson(responseData);
